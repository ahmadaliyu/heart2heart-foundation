...
export function HeroVideo() {
  ...
  return <>
    ...
    <dialog ref={dialog} className="video-dialog" onCancel={close} onClose={() => { if (frame.current) frame.current.src = "about:blank"; }} onClick={e => { if (e.target === e.currentTarget) close(); }} aria-label="Mental health video">
      ...
      <iframe ref={frame} title="There is no shame in taking care of your mental health — Sangu Delle, TED" allow="autoplay; encrypted-media; picture-in-picture; fullscreen" allowFullScreen />
      <a href="https://www.youtube.com/watch?v=BvpmZktlBFs" target="_blank" rel="noopener noreferrer">Watch on YouTube <span aria-hidden="true">↗</span></a>
    </dialog>
  </>;
}
