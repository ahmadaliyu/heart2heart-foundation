...
export const events: FoundationEvent[] = [
  {
    ...
    location: "Government Girls' Secondary School, Gwarinpa, Abuja",
  ...
  },
  {
    ...
    description:
      "An evening seminar for married women on communication patterns, family pressure and knowing when to seek support. Led by Dr. Amina Yusuf.",
    kind: "SEMINAR",
    startsAt: daysFromNow(21, 16),
    endsAt: daysFromNow(21, 18, 30),
    location: "Foundation Centre, Wuse II, Abuja",
    organiser: "Heart2Heart Foundation",
    registrationUrl: "#register",
    status: "OPEN",
    capacity: 60,
  ...
  },
  {
    ...
    location: "Four schools, Kubwa, Abuja",
    organiser: "Zainab Sani, Outreach Coordinator",
    status: "UPCOMING",
  },
  {
    ...
    location: "Utako Community Hall, Abuja",
    organiser: "Heart2Heart Foundation",
    registrationUrl: "#register",
    status: "UPCOMING",
    capacity: 250,
  ...
  },
  {
    ...
    location: "Two schools, Nyanya, Abuja",
    organiser: "Zainab Sani, Outreach Coordinator",
    status: "PAST",
  },
];
